...
class LatteT2V(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        #-----------应用xformers包装attention_mask--------------#
        # if attention_mask is not None:
        #     import xformers
        #     attention_mask = xformers.ops.fmha.BlockDiagonalMask.from_seqlens([hidden_states.shape[1]] * hidden_states.shape[0],attention_mask)
        ...
        for i, (spatial_block, temp_block) in enumerate(zip(self.transformer_blocks, self.temporal_transformer_blocks)):
            ...
            if self.training and self.gradient_checkpointing:
                ...
                # print("else",attention_mask.shape)
                # print(attention_mask)
                # print("else",encoder_attention_mask.shape)
                # print(encoder_attention_mask)
                # print("spatial_block hidden_states dtype: ",hidden_states.dtype)
                ...
                if enable_temporal_attentions:
                    ...
                    if use_image_num != 0 and self.training:
                        ...
                        if i == 0:
                            hidden_states = hidden_states + self.temp_pos_embed
                        # print("temp_block hidden_states dtype: ",hidden_states.dtype)
