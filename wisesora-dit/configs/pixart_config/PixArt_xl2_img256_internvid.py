...
data = dict(type='InternVIdv2', root=data_root, transform='default_train')
image_size = 256
...
gradient_clip = 0.01
optimizer = dict(type='AdamW', lr=2.5e-6, weight_decay=3e-2, eps=1e-10)
...
resume_from = dict(checkpoint="output/train_open_InternVId_256_500000images_resume_1/checkpoints/epoch_9_step_181000.pth", load_ema=False, resume_optimizer=False, resume_lr_scheduler=False)
