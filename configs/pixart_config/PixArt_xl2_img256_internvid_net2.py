...
load_from = "Latte/t2v_v20240523.pt"
...
resume_from = dict(checkpoint="output/net2_500000/checkpoints/epoch_8_step_76900.pth", load_ema=False, resume_optimizer=False, resume_lr_scheduler=False)
